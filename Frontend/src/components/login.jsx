  ...
  return (
    <div>
      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 flex flex-col gap-4">
            ...
            <label className="input validator flex items-center gap-2 border border-gray-500 rounded px-3 py-2">
      <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor">
      ...
      <input
        ...
        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
        title="Must be more than 8 characters, including number, lowercase letter, uppercase letter"
        className="flex-1 bg-transparent outline-none outline-none focus:outline-none focus:ring-0 focus:border-transparent"
        {...register("Password", { required: true })}
      />
